...
def process_data(is_train=True):
    ...
    if is_train:
        ...
        df = pd.read_csv(os.path.join(base_data_path, '/home/pavel/VSC/Ozon-Tech-E-Cup-bebryata/data/train/ml_ozon_сounterfeit_train.csv'))
    else:
        print("Обработка TEST данных...")
        base_data_path += 'test/'
        df = pd.read_csv(os.path.join(base_data_path, '/home/pavel/VSC/Ozon-Tech-E-Cup-bebryata/data/test/ml_ozon_сounterfeit_test.csv'))
