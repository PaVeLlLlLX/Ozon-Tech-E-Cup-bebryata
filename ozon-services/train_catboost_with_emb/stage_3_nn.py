...
def train_final_model():
    SEED = 42
    N_TRIALS = 1 # Количество попыток для подбора параметров. Можете уменьшить до 10-15 для скорости.
    ...
    #best_params = {'iterations': 1876, 'depth': 10, 'learning_rate': 0.018160515447969497, 'l2_leaf_reg': 3.4568619551960214, 'border_count': 103, 'bagging_temperature': 0.1692463585742141, 'random_strength': 0.0013520341843385793}
